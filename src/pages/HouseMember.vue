<template>
  <div class="house-member">
    <div class="house-info">
      <Fitimg v-if="house.StageImg" :src="'http://jindi.1juke.cn/'+house.StageImg" class="bg"/>
      <div class="wrapper">
        <div class="top">
          <div class="project">
        ...
        <div class="bottom">
          <span class="sign-time">签约时间：{{house.SignTime}}</span>
          <span class="repair-time">报修期止：{{house.Warranty}}</span>
        </div>
      </div>
    </div>
