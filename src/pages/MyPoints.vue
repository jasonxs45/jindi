        ...
        <div class="help-wrapper">
          ...
          <div class="details">
            <dl>
              ...
              <dd class="linetext">一、关注并绑定房源获取100积分；</dd>
              ...
              <dd class="linetext" style="display:none">四、转发本公众号所发布的活动信息可获得10积分（每个用户每天最多只能获得两次转发奖励，一种是成功分享到朋友圈，一种是成功分享给好友或群）；</dd>
              <dd class="linetext" style="display:none">五、通过专属二维码邀请好友关注本公众号可获得相应的积分奖励，推荐奖励为10积分，每天最多奖励100积分（注册会员可获得专属的推广二维码图片，用户可邀请好友扫码关注公众号获得积分奖励）；</dd>
              <dd class="linetext">三、获得在线报修服务后，提交服务评价的，可获得50积分（有效报修，不封顶）；</dd>
              <dd class="linetext">四、参与在线调查问卷填写并完成提交可获得积分奖励（由本公众号平台按单个问卷难易程度具体配置积分奖励额度）</dd>
